...
import InventoryModal from "@/app/components/InventoryModal.js"
...
type Inventory = {
    ...
    image: string;        // URL or base64 string of the item's image
    date: Date;           // Date when the item was added or updated
};
...
export default function InventoryPage() {
    ...
    const data = [
        { no: 1, code: "Proyektor1", name: "Proyektor", image: "/images/proyektor.JPG", stock: 0, date: "15/12/2024" },
        { no: 2, code: "Meja Siswa1", name: "Kabel Olor", image: "/images/kabelolor.jpg", stock: 0, date: "15/12/2024" },
        { no: 3, code: "Kursi Siswa1", name: "Kursi Siswa", image: "/images/mejakursi.jpg", stock: 0, date: "15/12/2024" },
        { no: 4, code: "Papan Tulis1", name: "Kabel HDMI", image: "/images/hdmi.jpg", stock: 0, date: "15/12/2024" },
        { no: 5, code: "Komputer1", name: "Meja Siswa", image: "/images/mejakursi.jpg", stock: 0, date: "15/12/2024" },
    ];
    ...
    const handleModalSubmit = (data: Inventory) => {
    ...
    return (
        <div className="flex-1 flex flex-col overflow-hidden bg-[#F2F2F2]">
            <header className="py-6 px-9 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <div>
                    <h1 className="text-2xl font-bold text-[var(--text-semi-bold-color)]">Inventory</h1>
                        ...
                        <table className="min-w-full rounded-lg overflow-hidden">
                            <thead className="text-[var(--text-semi-bold-color)]">
                                <tr>
                                    ...
                                    <th className="py-2 px-4 border-b text-left">Code Barang</th>
                                    <th className="py-2 px-4 border-b text-left">Nama Barang</th>
                                    <th className="py-2 px-4 border-b text-left">Foto Barang</th>
