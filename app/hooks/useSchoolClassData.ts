...
import { SchoolClass, UpdateSchoolClassDto } from '@/app/api/school-class-data/types';
import { schoolClassesApi } from '@/app/api/school-class-data';
...
export const useSchoolClasses = () => {
    ...
    const createSchoolClass = async (data: Omit<SchoolClass, 'id' | 'major' | 'homeroomTeacher'>) => {
        try {
