    ...
    return (
        <div className="bg-white w-64 space-y-6 py-7 px-4 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-300 ease-in-out">
            ...
            <nav>
                <a
                    href="#"
                    className={`block py-3 px-4 rounded-md transition duration-200 text-[var(--text-thin-color)] ${activeMenu === 'Beranda' ? 'active' : ''}`}
                ...
                <div>
                    ...
                    <div className={` ${isDropdownOpen ? '' : 'hidden'}`}>
                        ...
                        <a
                            href="#"
                            className={`block py-3 px-4 rounded-md transition duration-200 submenu text-[var(--text-thin-color)] ${activeMenu === 'Submenu 2' ? 'active' : ''}`}
                ...
                <a
                    href="#"
                    className={`block py-3 px-4 rounded-md transition duration-200 text-[var(--text-thin-color)] ${activeMenu === 'Humas' ? 'active' : ''}`}
                ...
                <a
                    href="#"
                    className={`block py-3 px-4 rounded-md transition duration-200 text-[var(--text-thin-color)] ${activeMenu === 'Tata Usaha' ? 'active' : ''}`}
                ...
                <a
                    href="#"
                    className={`block py-3 px-4 rounded-md transition duration-200 text-[var(--text-thin-color)] ${activeMenu === 'Keuangan' ? 'active' : ''}`}
                ...
                <a
                    href="#"
                    className={`block py-3 px-4 rounded-md transition duration-200 text-[var(--text-thin-color)] ${activeMenu === 'Kesiswaan' ? 'active' : ''}`}
                ...
                <a
                    href="#"
                    className={`block py-3 px-4 rounded-md transition duration-200 text-[var(--text-thin-color)] ${activeMenu === 'Sarpras' ? 'active' : ''}`}
            ...
            <a href="/login" className="absolute bottom-5 left-2 right-2 px-3">
                <button className="flex items-center justify-center w-full py-3 rounded-md border border-[var(--text-semi-bold-color)] bg-white text-[var(--text-semi-bold-color)] hover:opacity-90 transition">
