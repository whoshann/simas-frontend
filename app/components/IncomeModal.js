...
export default function IncomeData({ isOpen, onClose, onSubmit, incomeData }) {
    ...
    const [formData, setFormData] = React.useState(incomeData || {
        ...
        name: '',
        quantity: 1,
        date: new Date(), // Initialize with the current date, or set to null/empty string if not needed
    });
