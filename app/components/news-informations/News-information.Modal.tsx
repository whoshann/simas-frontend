...
interface NewsInformationModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: NewsInformation) => void;
    newsinformationData?: NewsInformation | null;
}

export const NewsInformationModal: React.FC<NewsInformationModalProps> = ({ isOpen, onClose, onSubmit, newsinformationData }) => {
    if (!isOpen) return null;

    const [formData, setFormData] = useState<NewsInformation>(newsinformationData || {
        photo: '',
        title: '',
        description: '',
        date: '',
            ...
            <div className="bg-white rounded-lg shadow-lg relative w-[28rem] max-h-[80vh] overflow-hidden mx-4">
                <div className="bg-white p-4 sticky top-0 z-10">
                    ...
                    <h2 className="text-xl mb-2 font-semibold text-[var(--text-semi-bold-color)]">
                        {newsinformationData ? 'Edit Data Berita Sekolah' : 'Tambah Data Berita Sekolah'}
                    </h2>
                </div>
                <div className="overflow-y-auto max-h-[70vh] p-4">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mb-4">
                            <label className="block mb-1 text-[var(--text-semi-bold-color)]">Tanggal (Opsional)</label>
                            <input
                                type="date"
                                name="date"
                                value={formData.date}
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                {newsinformationData ? 'Update' : 'Kirim'}
                            </button>
                        </div>
                    </form>
                </div>
