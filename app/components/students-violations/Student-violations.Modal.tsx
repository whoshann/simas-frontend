...
interface StudentViolationsModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: StudentViolations) => void;
    studentviolationsData?: StudentViolations | null;
}

export const StudentViolationsModal: React.FC<StudentViolationsModalProps> = ({ isOpen, onClose, onSubmit, studentviolationsData }) => {
    if (!isOpen) return null;

    const [formData, setFormData] = useState<StudentViolations>(studentviolationsData || {
        name: '',
        classSchool: '',
        violations: '',
        category: '',
            ...
            <div className="bg-white rounded-lg shadow-lg relative w-[28rem] max-h-[80vh] overflow-hidden mx-4">
                <div className="bg-white p-4 sticky top-0 z-10">
                    ...
                    <h2 className="text-xl mb-2 font-semibold text-[var(--text-semi-bold-color)]">
                        {studentviolationsData ? 'Edit Data Ruang Sekolah' : 'Tambah Data Ruang Sekolah'}
                    </h2>
                </div>
                <div className="overflow-y-auto max-h-[70vh] p-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label className="block mb-1 text-[var(--text-semi-bold-color)]">Pelanggaran</label>
                            <input
                                type="text"
                                name="violations"
                        ...
                        <div className="mb-4">
                            <label className="block mb-1 text-[var(--text-semi-bold-color)]">Hukuman</label>
                            <input
                                type="text"
                                name="punishment"
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                {studentviolationsData ? 'Update' : 'Kirim'}
                            </button>
                        </div>
                    </form>
                </div>
...
export default StudentViolationsModal;