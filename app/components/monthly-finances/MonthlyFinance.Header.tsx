interface MonthlyFinanceHeaderProps {
    searchTerm: string;
    onSearchChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
}

export const MonthlyFinanceHeader: React.FC<MonthlyFinanceHeaderProps> = ({ searchTerm, onSearchChange }) => (
    <header className="py-6 px-9 flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div>
            <h1 className="text-2xl font-bold text-[var(--text-semi-bold-color)]">Keuangan Bulanan</h1>
