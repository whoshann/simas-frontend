...
export const RepairsHeader: React.FC<RepairsHeaderProps> = ({ searchTerm, onSearchChange }) => {
    const { user } = useUser(); // Pindahkan hook ke dalam komponen
    
    return (
        <header className="py-6 px-9 flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div>
                <h1 className="text-2xl font-bold text-[var(--text-semi-bold-color)]">Data Perbaikan</h1>
