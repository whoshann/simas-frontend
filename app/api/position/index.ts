...
export const positionsApi = {
    ...
    create: async (data: Omit<Position, "id" | "createdAt" | "updatedAt">): Promise<PositionsResponse> => {
        const response = await axios.post(API_URL, data, { headers: getHeaders() });
        return response.data;
    },

    update: async (id: number, data: Partial<Position>): Promise<PositionsResponse> => {
    ...
    delete: async (id: number): Promise<PositionsResponse> => {
